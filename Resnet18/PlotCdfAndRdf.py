...
for jjj in [0,1,2,3,4,5,10,15,20,40,50,60,70,80]:
    ...
    #plt.title('%s -1layer 1/delta_v.s._LFR distribution function'%jjj,fontsize=15)        
    #ax.set_yscale('log')
    ...
    fntmp = '%s%s -1层 count backwards of delta v.s. LFR 分布函数'%(target_folder,jjj)
    ...
    ax = plt.gca()
    #plt.plot(all_m,all_Q_ini,'k*',label='Q_ini')
    #plt.plot(delta_range_plot,LFR_layer71,'ro-',label='layer7')
    ...
    #plt.ylim([0.31,0.32])
    plt.legend(fontsize=18) 
    fntmp = '%s%s -1层 count backwards of delta_v.s._LFR 密度函数'%(target_folder,jjj)
    mySaveFig(plt,fntmp,ax=ax,isax=1,iseps=0)
    ...
    ax = plt.gca()
    #plt.plot(all_m,all_Q_ini,'k*',label='Q_ini')
    #plt.plot(delta_range_plott,LFR_layer7t2,'ro-',label='layer7')
    ...
    #plt.ylim([0.31,0.32])
    plt.legend(fontsize=18) 
    fntmp = '%s%s -2层 count backwards of delta v.s. LFR 分布函数'%(target_folder,jjj)
    mySaveFig(plt,fntmp,ax=ax,isax=1,iseps=0)
    '''
    plt.figure()
    ax = plt.gca()
    #plt.plot(all_m,all_Q_ini,'k*',label='Q_ini')
    #plt.plot(delta_range_plot,LFR_layer72,'ro-',label='layer7')
    ...
    #plt.title('%s -2layer 1/delta_v.s._LFR density function'%jjj,fontsize=15)        
    #ax.set_yscale('log')
    plt.xlabel(r'$1/\delta$',fontsize=20)
    ...
    #plt.ylim([0.31,0.32])
    plt.legend(fontsize=18) 
    fntmp = '%s%s -2层 count backwards of delta_v.s._LFR 密度函数'%(target_folder,jjj)
    mySaveFig(plt,fntmp,ax=ax,isax=1,iseps=0)
